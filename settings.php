 ...
 */
 ...
 if ($ADMIN->fulltree) {
    $settings->add(new admin_setting_configcheckbox(
        'enrol_magiclink/showincoursenavigation',
        get_string('showinsitenavigation', 'enrol_magiclink'),
        get_string('showinsitenavigation_desc', 'enrol_magiclink'),
        1
    ));

    $settings->add(new admin_setting_configcheckbox(
        'enrol_magiclink/showinsitenavigation',
